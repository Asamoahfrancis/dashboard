...
export default function Home() {
  return (
    <div className="p-4  bg-[#f5f4f9]">
      <Search />
      <section className="grid grid-cols-12 gap-4    mt-6">
        <Congratulations />
        <div className="col-span-2 shadow-md rounded-lg bg-white text-sm ">
          <Profits />
        </div>
        <div className="col-span-2 shadow-md  rounded-lg bg-white text-sm ">
          <Sales />
      ...
      <section className="grid grid-cols-12 grid-row-8 gap-4  mt-6">
        <Companygrowth />
        <div className="col-span-2  rounded-lg bg-white text-sm ">
          <Payments />
        </div>
        <div className="col-span-2  shadow-md rounded-lg bg-white text-sm ">
        ...
        <div className="col-start-9 col-end-13  bg-white  row-start-2 row-end-3 shadow-md rounded-lg">
          <ProfitReport />
        </div>
      </section>
